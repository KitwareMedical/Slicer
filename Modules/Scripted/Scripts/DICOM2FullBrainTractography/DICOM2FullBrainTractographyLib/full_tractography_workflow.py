...
class WorkflowConfiguration:
    ...
    def validate_dicom2nrrd(self, step_object, data):
        if data[step_object.id()]['DICOMRadioButton']:
            ...
            if self.dicomtonrrdconverter_parameter_node.GetStatusString() == 'Completing' or
                self.dicomtonrrdconverter_parameter_node.GetStatusString() == 'Completed' :
    ...
    def validate_dwi2dti(self, step_object, data):
        ...
        if self.diffusionweightedvolumemasking_parameter_node.GetStatusString() != "Completing" or
           self.diffusionweightedvolumemasking_parameter_node.GetStatusString() != "Completed" or:
